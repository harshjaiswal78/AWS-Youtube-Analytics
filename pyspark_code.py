...
# Predicate to filter data by region
predicate_pushdown = "region in ('ca','gb','us')"

# Load data from Glue catalog with pushdown predicate
...
# Reduce to one partition and convert back to DynamicFrame
datasink1 = dropnullfields3.toDF().coalesce(1)
df_final_output = DynamicFrame.fromDF(datasink1, glueContext, "df_final_output")

# Write final output to S3 in Parquet format, partitioned by region
